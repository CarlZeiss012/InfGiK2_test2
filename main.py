...
#    search_lat = ObjectProperty()
    ...
    def wczytaj(self):
        ...
        if len(dates) > 1: 
            ...
            if len(tpart) > 1:
               ...
               for i,j in predkosc:
                   vvv=i/j
                   vparty.append(vvv)
               vparty = [i/1000 for i in vparty]
               Vmax=max(vparty) 
               Vmin=min(vparty)
               abba=[i/1000 for i in dist]
               ...
               vparty.insert(0,0)
                ...
                self.lvmax.text="Brak info o czasie"
                self.lvmin.text="Brak info o czasie"
                self.lvave.text="Brak info o czasie"
        ...
        self.ax1.set_ylabel('Wysokosc n.p.m')
